/* POS Configurator - Release 4 - 0.4 - Nathan Staab - ITT-310-O500
...
#include <iostream> //IOStream For CIN!
#include <fstream> //FileStream For COUT/fget
...
int main()
{
    ...
    int numterms; //# Of POS Terminal
    int term_num; //POS Terminal #
